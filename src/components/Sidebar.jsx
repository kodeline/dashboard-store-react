...
const Sidebar = (props) => {
  ...
  return ( 
    <div 
      className={`bg-[#1e2029] fixed lg:left-0 top-0 w-28 h-full py-6 flex flex-col justify-between  rounded-tr-2xl rounded-br-2xl z-50 transition-all 
      ...
      <div>
        <ul className="pl-15">
          ...
          <li className="bg-[#262837] p-4 rounded-tl-xl rounded-bl-xl">
            <a 
              href="#" 
              className="bg-[#85d73d] p-4 flex justify-center rounded-xl text-white">
          ...
          <li className=" hover:bg-[#262837] p-4 rounded-tl-xl rounded-bl-xl group transition-colors">
            <a 
             href="#" 
              className="group-hover:bg-[#85d73d] p-4 flex justify-center rounded-xl text-[#85d73d] group-hover:text-white transition-colors">
